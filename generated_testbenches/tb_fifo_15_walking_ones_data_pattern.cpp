/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_15_walking_ones_data_pattern.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_15_walking_ones_data_pattern" << " - Walking Ones & Walking Zeroes Bus Integrity Test" << std::endl;
