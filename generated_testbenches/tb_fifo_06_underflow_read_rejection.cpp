/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_06_underflow_read_rejection.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_06_underflow_read_rejection" << " - FIFO Underflow Boundary Protection & Bus Stability" << std::endl;
