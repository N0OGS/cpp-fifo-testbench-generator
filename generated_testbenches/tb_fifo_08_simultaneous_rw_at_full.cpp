/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_08_simultaneous_rw_at_full.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_08_simultaneous_rw_at_full" << " - Simultaneous Read/Write at Full Boundary" << std::endl;
