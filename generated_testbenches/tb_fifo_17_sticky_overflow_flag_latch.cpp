/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_17_sticky_overflow_flag_latch.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_17_sticky_overflow_flag_latch" << " - Sticky Overflow Flag Latching and Reset Clearing" << std::endl;
