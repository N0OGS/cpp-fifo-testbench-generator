/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_03_burst_fill_to_full.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_03_burst_fill_to_full" << " - Burst Fill to Capacity (16 Consecutive Writes)" << std::endl;
