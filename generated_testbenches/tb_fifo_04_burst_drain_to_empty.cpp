/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_04_burst_drain_to_empty.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_04_burst_drain_to_empty" << " - Burst Drain to Zero (16 Consecutive Reads)" << std::endl;
