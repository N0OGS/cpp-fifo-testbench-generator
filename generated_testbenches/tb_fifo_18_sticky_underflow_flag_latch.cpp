/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_18_sticky_underflow_flag_latch.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_18_sticky_underflow_flag_latch" << " - Sticky Underflow Flag Latching and Reset Clearing" << std::endl;
