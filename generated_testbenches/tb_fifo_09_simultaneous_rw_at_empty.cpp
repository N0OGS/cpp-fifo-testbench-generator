/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_09_simultaneous_rw_at_empty.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_09_simultaneous_rw_at_empty" << " - Simultaneous Read/Write at Empty Boundary" << std::endl;
