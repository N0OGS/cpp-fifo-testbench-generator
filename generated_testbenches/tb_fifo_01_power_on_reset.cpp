/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_01_power_on_reset.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_01_power_on_reset" << " - Power-On Reset & Default Register Initial State" << std::endl;
