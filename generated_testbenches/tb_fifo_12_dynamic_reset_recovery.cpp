/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_12_dynamic_reset_recovery.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_12_dynamic_reset_recovery" << " - Dynamic Asynchronous/Synchronous Reset Mid-Burst" << std::endl;
