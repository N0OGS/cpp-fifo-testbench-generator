/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_10_ping_pong_single_element.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_10_ping_pong_single_element" << " - High-Frequency Ping-Pong Single Element Streaming" << std::endl;
