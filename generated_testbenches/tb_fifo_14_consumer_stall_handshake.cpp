/**
 * ============================================================================
 * PRE-SILICON VERIFICATION TESTBENCH: tb_fifo_14_consumer_stall_handshake.cpp
...
int main() {
    std::cout << "[TESTBENCH START] " << "tb_fifo_14_consumer_stall_handshake" << " - Downstream Consumer Stall and Throttled Dequeue" << std::endl;
